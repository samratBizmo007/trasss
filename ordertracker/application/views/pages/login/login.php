                                ...
                                <div id='Login_RegisterDiv'>
                                    <form id="login_form" role="form" method='post' enctype='multipart/form-data' style="display: block;">
                                        ...
                                        <div class="form-group"><?php ?>
                                            <input type="text" name="login_username" id="login_username" tabindex="2" class="form-control" placeholder="Username" value="<?php echo $_COOKIE['jumla_uname']; ?>" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="login_password" id="login_password" tabindex="3" class="form-control" value="<?php echo $_COOKIE['jumla_pass']; ?>" placeholder="Password" required>
                                        </div>
                                    ...
                                    <div id = "registerDiv">
                                        ...
                                        <div class="w3-col l12 form-group">
                                            <div class="w3-col l4 s4" style=" padding-right: 5px;">
                                                ...
                                                <div class="w3-col l8 s8"><input type="text" name="register_number" id="register_number" maxlength="10" class="form-control" placeholder="Enter Your Number" required></div>
                                            </div>
                                            <div class="form-group">
                                                <textarea rows="5" style="resize:none" name="address" id="address" class="form-control form-control rounded-0" placeholder="Enter Your Delivery Address" required></textarea>
                                            </div>
