...
class ViewProject_biddinglist extends CI_Controller {
    ...
    public function index($link='') {
        ...
        $data['bidList'] = ViewProject_biddinglist::get_biddedList($project_id);
        $data['details'] = ViewProject_biddinglist::getProjectDetails($project_id);
        $data['Skills'] = ViewProject_biddinglist::getProjectSkills($project_id);
        $data['EmployersRating'] = ViewProject_biddinglist::getDetails_OF_FreelanceEmployerRatings($project_id);
        $data['FreelancerRating'] = ViewProject_biddinglist::getDetails_OF_FreelancerRatings($project_id);
        $this->load->view('includes/header.php');
        $this->load->view('pages/project/projectbidding_list', $data);
