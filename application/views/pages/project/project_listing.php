            ...
            <div class="">
              <form class="form-group">
                <span>
                  <div class="w3-col l12 ">
                    <div class="w3-col l2">
                     <label class="w3-margin-left w3-medium"><b>Job Types:</b></label>
                   </div>
      ...
      if($info['status']==1)
      {
        ...
        { 
          ...
          if($user_id=''|| $profile_type==''){
            $view_link=base_url().'auth/login?profile=2&payload=ViewProject&value='.base64_encode($key['jm_project_id']);
          }
          ...
          <div class="w3-col l12"><a href="'.$view_link.'" class="w3-small w3-padding-left w3-padding-right w3-black w3-right w3-round-xlarge w3-padding-tiny btn">View Project</a></div>
          ...
          <div class="w3-col l6 s6"><a href="'.$view_link.'" class="w3-small w3-black w3-right w3-padding-left w3-padding-right w3-round-xlarge w3-padding-tiny btn">View Project</a>
          </div>
