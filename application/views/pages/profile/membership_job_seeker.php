...
<head>
	...
	<title>Job Seeker Membership Table</title>
...
<!-- =================================================MOBILE VERSION CODE FOR THE PLANS=================================-->
	<div class="span11 w3-hide-large w3-hide-small scroll_mob" style="overflow: auto;">
		<div class="row-fluid">
			<div class="horizontal">
				<div class="col-lg-1"></div>
				<div class="w3-col l8">
				<div class="btn-group btn-toggle w3-center w3-margin-bottom"> 
...
<!--					<div class="w3-col l12 w3-center w3-margin-top w3-margin-bottom">-->
<!--						<button id="button" class="w3-button " onclick="switchVisible();">Monthly/yearly</button> -->
<!--					</div>-->
					<div class="w3-col l12" id="show_div" style="display: none;">
						<div class="col-lg-3"></div>
						<div class="col-lg-3">
