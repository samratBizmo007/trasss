            ...
            <div class="w3-col l3 w3-padding-small">
              <div class="w3-col l12 dashboard_blocks w3-white">
                ...
                <div class="w3-col l12 scrollbar w3-padding-small" id="style-2" style="height: 90px;">
                  <?php 
                  print_r($all_freeSkills);
                    if($all_freeSkills['status']!=200){
                      echo '<center><label class="w3-small w3-text-grey">'.$all_freeSkills['status_message'].'</label></center>';
                    }
                    else{
                      foreach($all_freeSkills['status_message'] as $result) { 
