                  ...
                  <div class="w3-col l6 w3-border-right w3-border-left <?php echo $hide_rateDiv; ?>" style="padding: 0 32px 16px 32px">
                    <div class="w3-col l12 w3-padding">
                      <div class="col-lg-12 w3-white w3-padding-top w3-center w3-circle prof_pic">
                        <div class="w3-padding-top"><h2><i class="fa fa-inr"></i> <?php echo $details['jm_ratePerHr']; ?></h2>
...
<!-- script to dispaly stars -->
                ...
                <div class="w3-col l8 ">
                  ...
                  <div class="w3-col l4 w3-padding <?php if($profile_type==1 || $profile_type==3){echo '';}else{echo 'w3-hide';} ?>">
                    <div class="w3-col l12 w3-card-2">
                      ...
                      <div class="w3-col l12">
                        ...
                        ?>         
                        <div class="w3-col l12 w3-center">
                          <a href="<?php echo base_url(); ?>profile/dashboard" class="btn bluish-green w3-small">Add More</a>
                        </div>
                      </div>
                    </div>
                  </div>
                  <div class="w3-col l4 w3-padding">
                    <div class="w3-col l12 w3-card-2">
                      ...
                      <div class="w3-col l12 w3-center">
                        <a href="<?php echo base_url(); ?>profile/edit_profile#educationDiv" class="btn bluish-green w3-small">Add More</a>
                      </div>
                    </div>
                  </div>
                  <div class="w3-col l4 w3-padding">
                    ...
                    <div class="w3-col l12 w3-center">
                      <a href="<?php echo base_url(); ?>profile/edit_profile#experienceDiv" class="btn bluish-green w3-small">Add More</a>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div class="w3-row w3-margin-bottom w3-text-black">
            <div class="w3-col l12 w3-padding">
              ...
              <div class="w3-col l12">
                <center>
                  <a data-toggle="modal" data-target="#addPortfolio" class="btn w3-round-xlarge w3-border w3-padding-tiny w3-padding-left w3-padding-right port_button w3-margin"><label class="w3-padding-tiny">Add More</label></a>
                </center>
